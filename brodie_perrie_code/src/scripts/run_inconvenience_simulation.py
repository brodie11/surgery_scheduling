...
for iter in range(num_runs):
    ...
    for perfect_info_bool in perfect_infos_considered:
        #OVERTIME LOOP
        overtimes_considered = [0, 15, 30, 45, 60] if is_overtime_considered else [allowed_overtime]
        for allowed_overtime in overtimes_considered:
            
            # PERCENTILES LOOP
            percentiles_considered = [20, 30, 40, 45, 50, 55, 60, 70] if percentiles_considered else [percentile_value]
